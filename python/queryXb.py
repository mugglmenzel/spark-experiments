...
file.write("\n\n")
file.write(" ====================================\n")
file.write(" =  RUNNING QUERY Xb                =\n")
file.write(" ====================================\n\n")

sc = SparkContext("spark://10.97.31.179:7077", "Query Xb")

file.write("Spark Context: " + str(current_milli_time()-start) + "\n\n")
start = current_milli_time()

data1 = sc.textFile("/srtec/kjan2009.csv").map(lambda line: 1)
data2 = sc.textFile("/srtec/kjun2009.csv").map(lambda line: 1)
data3 = sc.textFile("/srtec/kmar2009.csv").map(lambda line: 1)
data4 = sc.textFile("/srtec/kmay2009.csv").map(lambda line: 1)
